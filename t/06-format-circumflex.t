...
def_format_test 'format.^.{.21' =>
  "~{~1,v^~A~}", [ [ undef, 8, undef, 7, 0, 6, 1, 5 ] ], "876";

def_format_test 'format.^.{.22' =>
  "~{~0,v^~A~}", [ [ 3, 8, 1, 7, 3, 6, undef, 5 ] ], "876";
...
def_format_test 'format.^.{.25' =>
  "~{~1,1,v^~A~}", [ [ 0, 1, 0, 2, 0, 3, undef, 4 ] ], "123";

def_format_test 'format.^.{.26' =>
  "~{~'X^~A~}", [ [ 1, 2, 3 ] ], "123";

def_format_test 'format.^.{.27' =>
  "~{~v,'X^~A~}", [ [ 0, 1, 'x', 2, undef, 3, 'X', 4, 0, 5 ] ], "123";

def_format_test 'format.^.{.28' =>
  "~{~'X,v^~A~}", [ [ 0, 1, 'x', 2, undef, 3, 'X', 4, 0, 5 ] ], "123";
